...
<AdapterType Name="ADepot" Comment="Adapter Interface">
	...
	<InterfaceList>
		<EventInputs>
			<Event Name="Ready" Type="Event" Comment="Request from Socket">
			</Event>
		</EventInputs>
		<EventOutputs>
			<Event Name="GetSpinner" Type="Event" Comment="Indication from Plug">
				<With Var="StoragePosition"/>
			</Event>
		</EventOutputs>
		<OutputVars>
			<VarDeclaration Name="StoragePosition" Type="WORD" Comment="Confirmation Data from Plug"/>
		</OutputVars>
	</InterfaceList>
