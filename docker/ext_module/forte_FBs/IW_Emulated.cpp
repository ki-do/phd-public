...
#include "IW_Emulated.h"
#ifdef FORTE_ENABLE_GENERATED_SOURCE_CPP
#include "IW_Emulated_gen.cpp"
#endif

DEFINE_FIRMWARE_FB(FORTE_IW_Emulated, g_nStringIdIW_Emulated)

const CStringDictionary::TStringId FORTE_IW_Emulated::scm_anDataInputNames[] = {g_nStringIdQI, g_nStringIdPARAMS, g_nStringIdPORT_NAME};

const CStringDictionary::TStringId FORTE_IW_Emulated::scm_anDataInputTypeIds[] = {g_nStringIdBOOL, g_nStringIdSTRING, g_nStringIdWSTRING};

const CStringDictionary::TStringId FORTE_IW_Emulated::scm_anDataOutputNames[] = {g_nStringIdQO, g_nStringIdSTATUS, g_nStringIdIN};

const CStringDictionary::TStringId FORTE_IW_Emulated::scm_anDataOutputTypeIds[] = {g_nStringIdBOOL, g_nStringIdSTRING, g_nStringIdWORD};

const TForteInt16 FORTE_IW_Emulated::scm_anEIWithIndexes[] = {0, 4};
const TDataIOID FORTE_IW_Emulated::scm_anEIWith[] = {1, 0, 2, 255, 0, 255};
const CStringDictionary::TStringId FORTE_IW_Emulated::scm_anEventInputNames[] = {g_nStringIdINIT, g_nStringIdREQ};

const TDataIOID FORTE_IW_Emulated::scm_anEOWith[] = {0, 1, 255, 0, 2, 1, 255};
const TForteInt16 FORTE_IW_Emulated::scm_anEOWithIndexes[] = {0, 3, -1};
const CStringDictionary::TStringId FORTE_IW_Emulated::scm_anEventOutputNames[] = {g_nStringIdINITO, g_nStringIdCNF};

const SFBInterfaceSpec FORTE_IW_Emulated::scm_stFBInterfaceSpec = {
...
const SCFB_FBInstanceData FORTE_IW_Emulated::scm_astInternalFBs[] = {
...
const SCFB_FBParameter FORTE_IW_Emulated::scm_astParamters[] = {
  {0, g_nStringIdIN, "OK"},
  {1, g_nStringIdQI, "1"},
};

const SCFB_FBConnectionData FORTE_IW_Emulated::scm_astEventConnections[] = {
...
const SCFB_FBConnectionData FORTE_IW_Emulated::scm_astDataConnections[] = {
...
const SCFB_FBNData FORTE_IW_Emulated::scm_stFBNData = {
