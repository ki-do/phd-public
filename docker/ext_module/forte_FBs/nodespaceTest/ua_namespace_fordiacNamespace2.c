...
#include "../nodespaceTest/ua_namespace_fordiacNamespace2.h"


/* TestObject - ns=1;i=15001 */

static UA_StatusCode function_ua_namespace_fordiacNamespace2_0_begin(UA_Server *server, UA_UInt16* ns) {
...
static UA_StatusCode function_ua_namespace_fordiacNamespace2_0_finish(UA_Server *server, UA_UInt16* ns) {
...
static UA_StatusCode function_ua_namespace_fordiacNamespace2_1_begin(UA_Server *server, UA_UInt16* ns) {
...
static UA_StatusCode function_ua_namespace_fordiacNamespace2_1_finish(UA_Server *server, UA_UInt16* ns) {
#ifdef UA_ENABLE_METHODCALLS
...
static UA_StatusCode function_ua_namespace_fordiacNamespace2_2_begin(UA_Server *server, UA_UInt16* ns) {
UA_StatusCode retVal = UA_STATUSCODE_GOOD;
...
static UA_StatusCode function_ua_namespace_fordiacNamespace2_2_finish(UA_Server *server, UA_UInt16* ns) {
return UA_Server_addNode_finish(server, 
UA_NODEID_NUMERIC(ns[1], 15008)
);
}
...
static UA_StatusCode function_ua_namespace_fordiacNamespace2_3_begin(UA_Server *server, UA_UInt16* ns) {
UA_StatusCode retVal = UA_STATUSCODE_GOOD;
UA_VariableAttributes attr = UA_VariableAttributes_default;
attr.minimumSamplingInterval = 0.000000;
attr.userAccessLevel = 1;
...
static UA_StatusCode function_ua_namespace_fordiacNamespace2_3_finish(UA_Server *server, UA_UInt16* ns) {
return UA_Server_addNode_finish(server, 
UA_NODEID_NUMERIC(ns[1], 15009)
);
}
...
static UA_StatusCode function_ua_namespace_fordiacNamespace2_4_begin(UA_Server *server, UA_UInt16* ns) {
#ifdef UA_ENABLE_METHODCALLS
UA_StatusCode retVal = UA_STATUSCODE_GOOD;
UA_MethodAttributes attr = UA_MethodAttributes_default;
attr.executable = true;
...
static UA_StatusCode function_ua_namespace_fordiacNamespace2_4_finish(UA_Server *server, UA_UInt16* ns) {
#ifdef UA_ENABLE_METHODCALLS
return UA_Server_addMethodNode_finish(server, 
UA_NODEID_NUMERIC(ns[1], 15004)
, NULL, 0, NULL, 0, NULL);
...
static UA_StatusCode function_ua_namespace_fordiacNamespace2_5_begin(UA_Server *server, UA_UInt16* ns) {
UA_StatusCode retVal = UA_STATUSCODE_GOOD;
UA_VariableAttributes attr = UA_VariableAttributes_default;
attr.minimumSamplingInterval = 0.000000;
attr.userAccessLevel = 1;
...
static UA_StatusCode function_ua_namespace_fordiacNamespace2_5_finish(UA_Server *server, UA_UInt16* ns) {
return UA_Server_addNode_finish(server, 
UA_NODEID_NUMERIC(ns[1], 15005)
);
}
...
static UA_StatusCode function_ua_namespace_fordiacNamespace2_6_begin(UA_Server *server, UA_UInt16* ns) {
UA_StatusCode retVal = UA_STATUSCODE_GOOD;
UA_VariableAttributes attr = UA_VariableAttributes_default;
attr.minimumSamplingInterval = 0.000000;
attr.userAccessLevel = 1;
...
static UA_StatusCode function_ua_namespace_fordiacNamespace2_6_finish(UA_Server *server, UA_UInt16* ns) {
return UA_Server_addNode_finish(server, 
UA_NODEID_NUMERIC(ns[1], 15006)
);
}
...
static UA_StatusCode function_ua_namespace_fordiacNamespace2_7_begin(UA_Server *server, UA_UInt16* ns) {
UA_StatusCode retVal = UA_STATUSCODE_GOOD;
UA_VariableAttributes attr = UA_VariableAttributes_default;
attr.minimumSamplingInterval = 0.000000;
attr.userAccessLevel = 1;
...
static UA_StatusCode function_ua_namespace_fordiacNamespace2_7_finish(UA_Server *server, UA_UInt16* ns) {
return UA_Server_addNode_finish(server, 
UA_NODEID_NUMERIC(ns[1], 15002)
);
}
...
static UA_StatusCode function_ua_namespace_fordiacNamespace2_8_begin(UA_Server *server, UA_UInt16* ns) {
UA_StatusCode retVal = UA_STATUSCODE_GOOD;
UA_VariableAttributes attr = UA_VariableAttributes_default;
attr.minimumSamplingInterval = 0.000000;
attr.userAccessLevel = 1;
...
static UA_StatusCode function_ua_namespace_fordiacNamespace2_8_finish(UA_Server *server, UA_UInt16* ns) {
return UA_Server_addNode_finish(server, 
UA_NODEID_NUMERIC(ns[1], 15003)
);
}

UA_StatusCode ua_namespace_fordiacNamespace2(UA_Server *server) {
UA_StatusCode retVal = UA_STATUSCODE_GOOD;
...
bool dummy = (
!(retVal = function_ua_namespace_fordiacNamespace2_0_begin(server, ns)) &&
!(retVal = function_ua_namespace_fordiacNamespace2_1_begin(server, ns)) &&
!(retVal = function_ua_namespace_fordiacNamespace2_2_begin(server, ns)) &&
!(retVal = function_ua_namespace_fordiacNamespace2_3_begin(server, ns)) &&
!(retVal = function_ua_namespace_fordiacNamespace2_4_begin(server, ns)) &&
!(retVal = function_ua_namespace_fordiacNamespace2_5_begin(server, ns)) &&
!(retVal = function_ua_namespace_fordiacNamespace2_6_begin(server, ns)) &&
!(retVal = function_ua_namespace_fordiacNamespace2_7_begin(server, ns)) &&
!(retVal = function_ua_namespace_fordiacNamespace2_8_begin(server, ns)) &&
!(retVal = function_ua_namespace_fordiacNamespace2_8_finish(server, ns)) &&
!(retVal = function_ua_namespace_fordiacNamespace2_7_finish(server, ns)) &&
!(retVal = function_ua_namespace_fordiacNamespace2_6_finish(server, ns)) &&
!(retVal = function_ua_namespace_fordiacNamespace2_5_finish(server, ns)) &&
!(retVal = function_ua_namespace_fordiacNamespace2_4_finish(server, ns)) &&
!(retVal = function_ua_namespace_fordiacNamespace2_3_finish(server, ns)) &&
!(retVal = function_ua_namespace_fordiacNamespace2_2_finish(server, ns)) &&
!(retVal = function_ua_namespace_fordiacNamespace2_1_finish(server, ns)) &&
!(retVal = function_ua_namespace_fordiacNamespace2_0_finish(server, ns)) 
); (void)(dummy);
return retVal;
}
