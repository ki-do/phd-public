...
#ifndef _AROBOT_DEMUX_H_
#define _AROBOT_DEMUX_H_
...
class FORTE_AROBOT_DEMUX: public CCompositeFB {
  DECLARE_FIRMWARE_FB(FORTE_AROBOT_DEMUX)
...
public:
  FORTE_AROBOT_DEMUX(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
      CCompositeFB(pa_poSrcRes, &scm_stFBInterfaceSpec, pa_nInstanceNameId, &scm_stFBNData, m_anFBConnData, m_anFBVarsData) {
  };

  virtual ~FORTE_AROBOT_DEMUX() = default;
};

#endif // _AROBOT_DEMUX_H_
