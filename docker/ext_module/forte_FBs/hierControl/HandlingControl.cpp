...
const TForteInt16 FORTE_HandlingControl::scm_anEOWithIndexes[] = {-1};
  ...
  do{
    ...
    switch(m_nECCState){
      case scm_nStateSTART:
        if(AHandling().PrepareSpinner() == pa_nEIID)
          enterStateState_14();
        else
          bTransitionCleared  = false; //no transition cleared
        break;
      case scm_nStateState_1:
        if((ARobot().PositionUpdate() == pa_nEIID) && (((ARobot().CurrentPosition() == 1))))
          enterStateState_2();
        else
          bTransitionCleared  = false; //no transition cleared
        break;
      case scm_nStateState_2:
        if(AGripper().Gripped() == pa_nEIID)
          enterStateState_3();
        else
          bTransitionCleared  = false; //no transition cleared
        break;
      case scm_nStateState_3:
        if((ARobot().PositionUpdate() == pa_nEIID) && (((ARobot().CurrentPosition() == 11))))
          enterStateState_4();
        else
          bTransitionCleared  = false; //no transition cleared
        break;
      case scm_nStateState_4:
        if(AGripper().Released() == pa_nEIID)
          enterStateState_15();
        else
          bTransitionCleared  = false; //no transition cleared
        break;
      ...
      case scm_nStateState_6:
        if((ARobot().PositionUpdate() == pa_nEIID) && (((ARobot().CurrentPosition() == 12))))
          enterStateState_16();
        else
          bTransitionCleared  = false; //no transition cleared
        break;
      case scm_nStateState_7:
        if((ARobot().PositionUpdate() == pa_nEIID) && (((ARobot().CurrentPosition() == 3))))
          enterStateState_8();
        else
          bTransitionCleared  = false; //no transition cleared
        break;
      ...
      case scm_nStateState_9:
        if((ARobot().PositionUpdate() == pa_nEIID) && (((ARobot().CurrentPosition() == 13))))
          enterStateState_17();
        else
          bTransitionCleared  = false; //no transition cleared
        break;
      case scm_nStateState_10:
        if((ARobot().PositionUpdate() == pa_nEIID) && (((ARobot().CurrentPosition() == 4))))
          enterStateState_11();
        else
          bTransitionCleared  = false; //no transition cleared
        break;
      ...
      case scm_nStateState_12:
        if((ARobot().PositionUpdate() == pa_nEIID) && (((ARobot().CurrentPosition() == 14))))
          enterStateState_18();
        else
          bTransitionCleared  = false; //no transition cleared
        break;
      case scm_nStateState_13:
        if((ARobot().PositionUpdate() == pa_nEIID) && (((ARobot().CurrentPosition() == 99))))
          enterStateState();
        else
          bTransitionCleared  = false; //no transition cleared
        break;
      ...
      case scm_nStateState_15:
        if((ARobot().PositionUpdate() == pa_nEIID) && (((ARobot().CurrentPosition() == 2))))
          enterStateState_5();
        else
          bTransitionCleared  = false; //no transition cleared
        break;
