...
#ifndef _STORAGESKILL_H_
#define _STORAGESKILL_H_

#include <basicfb.h>
#include "IAS_Skill.h"

class FORTE_StorageSkill: public CBasicFB{
  DECLARE_FIRMWARE_FB(FORTE_StorageSkill)
...
public:
  FORTE_StorageSkill(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) : 
       CBasicFB(pa_poSrcRes, &scm_stFBInterfaceSpec, pa_nInstanceNameId,
              0, m_anFBConnData, m_anFBVarsData){
  };

  virtual ~FORTE_StorageSkill(){};
