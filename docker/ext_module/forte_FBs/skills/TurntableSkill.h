...
#ifndef _TURNTABLESKILL_H_
#define _TURNTABLESKILL_H_

#include <basicfb.h>
#include <forte_word.h>
#include "IAS_Skill.h"

class FORTE_TurntableSkill: public CBasicFB{
  DECLARE_FIRMWARE_FB(FORTE_TurntableSkill)
...
public:
  FORTE_TurntableSkill(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) : 
       CBasicFB(pa_poSrcRes, &scm_stFBInterfaceSpec, pa_nInstanceNameId,
              0, m_anFBConnData, m_anFBVarsData){
  };

  virtual ~FORTE_TurntableSkill(){};
